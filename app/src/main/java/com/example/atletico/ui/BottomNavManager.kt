...
class BottomNavManager(
    ...
    private val navGraphIds =
        listOf(R.navigation.nav_home, R.navigation.nav_lineup, R.navigation.nav_article, R.navigation.nav_schedule)
    ...
    private var navHistory = BottomNavHistory().apply { push(R.id.nav_home) }
    ...
    private fun isFirstTab(): Boolean {
        return bottomNavigationView.selectedItemId == R.id.nav_home
    }
